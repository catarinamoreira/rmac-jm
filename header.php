...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body class="hidden <?php if(!isset($_COOKIE['eucookie'])) echo 'cookie'; ?> <?php echo $type; ?>" data-language="<?php echo $GLOBALS['currentLanguage']; ?>" data-baseurl="<?php echo BASE_URL; ?>" data-currenturl="<?php echo CURRENT_URL; ?>">
		...
		<?php endif; ?>
		<div class="scroll-pagenumber" style="display:none;">
			<span class="value">P.<span class="number">001</span><span class="arrow"></span></span>
